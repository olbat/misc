...
class TestAES(unittest.TestCase):
    ...
    TestVector = namedtuple('TestVector', ['moo', 'key', 'iv', 'text', 'cipher'])
    TEST_VECTORS = (
		# AES128-ECB
		TestVector(
			moo=aes.MoO.ECB,
    ...
    # FIXME: bug in the implementation, to be enabled when fixed
    ...
    #        self.assertEqual(tv.text, oio.read())
    ...
    def test_encrypt_decrypt(self):
        ...
        for tv in self.__class__.TEST_VECTORS:
            ...
            self.assertEqual(tv.text, iio.read())
